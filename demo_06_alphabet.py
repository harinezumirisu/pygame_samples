...
display1.init_row(X_ORG=2, Y_ORG=7, COL_INTV=6)   

display2 = LCD_font_mc(screen)
display2.__init__(screen)
display2.init_col(BLOCK_SIZE=5, BLOCK_INTV=7, COLOR_ON=GREEN, COLOR_OFF=GRAY)
display2.init_row(X_ORG=2, Y_ORG=21, COL_INTV=6)
